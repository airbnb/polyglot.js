...
!function(root) {
  ...
  function Polyglot(options) {
    ...
    this.allowNestedJSON = !!options.allowNestedJSON
  }
  ...
  Polyglot.prototype.t = function(key, options) {
    ...
    if(this.allowNestedJSON){
      // Deep search through JSON, split on "."
      phrase = this.phrases;
      var keys = key.split('.');
    ...
    if(typeof phrase != 'string') phrase = options._ || (this.allowMissing ? key : '');
